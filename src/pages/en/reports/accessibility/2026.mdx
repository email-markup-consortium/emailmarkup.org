...
We also recognize SFR Mail which supports all the accessibility features tested on "Can I Email?". Honourable mentions to Apple Mail, Samsung Email and Proton Mail, which are not far from the 100% mark.
