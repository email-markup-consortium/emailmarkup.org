...
From this we can see that 99.89% of emails tested contain accessibility issues categorized as "Serious" or "Critical". These are the highest categories and fixing these issues should be considered high priority. 
