...
Issues related to VML have fallen off the top ten list, and in its place, **Links must be distinguishable without relying on color**. We also saw the order of the issues presented change.
