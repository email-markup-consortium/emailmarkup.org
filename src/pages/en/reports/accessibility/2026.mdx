...
We are seeing some small improvements in the 2026 accessibility report, however too slow. We're still seeing 99.9% of email fail basic testing. 

Across the ecosystem, accessibility failures are systemic, widespread, and largely preventable. After analyzing 443,585 emails collected over the past year, we found that 99.9% contain accessibility issues rated “Serious” or “Critical.” Only 8 emails passed all automated accessibility checks, and they came from three brands.
...
> **Result**
>
> - 99.9% of HTML emails tested contain accessibility issues categorized as “Serious” or “Critical”.
...
The data was sourced by the Email Markup Consortium Data Collection project between May 2025 and May 2026. We collected 372,641 emails from multiple industries in multiple languages. 

- Number of emails collected between May 2025 and May 2026: 372,641
- Number of emails that could not be analyzed (due to invalid code): 56
- Number of emails analyzed: 372,585
...
| -------------- | --------------------   |
| Critical       | 57.96%% (215,947 emails)|
| Serious.       | 41.94% (156,275 emails)|
| Moderate       | 0.02% (78 emails)      |
| Mild           | 0.07% (277 emails)     |
| No issues      | 0.002% (8 emails)    |


From this we can see that 99.9% of emails tested contain accessibility issues categorised as "Serious" or "Critical". These are the highest categories and fixing these issues should be considered high priority.
...
In 2026 we're seeing a marginal regression in overall failure rate for Critical & Serious issues, moving from 99.89% in 2025 up to 99.9% in 2026.

However, we are seeing some consistent improvements across most of the top 10 issues.

| Description                             | Severity | 2023 % | 2024 % | 2025 % | 2026 % |
|-----------------------------------------|----------|--------|--------|--------|--------|
| Body content must have `dir` attribute  | Serious  | N/A    | 99.17  | 98.14  | 97.42  |
| Body content must have `lang` attribute | Serious  | 96.37  | 98.29  | 96.67  | 95.66  |
| Tables used for layout must have `role` | Serious  | 89.16  | 88.97  | 86.24  | 83.81  |
| Missing level-one heading               | Mild     | 81.7   | 79.23  | 76.78  | 74.25  |
| Links must have discernible text        | Serious  | 71.36  | 73.73  | 72.04  | 71.2   |
| `<html>` must have `lang` attribute     | Serious  | 72.19  | 68.32  | 67.01  | 62.23  |
| Insufficient color contrast             | Serious  | N/A    | N/A    | 59.37  | 58.45  |
| Images must have alternate text         | Critical | 55.26  | 57.89  | 51.42  | 47.86  |
| Missing `<title>` element               | Serious  | 35.05  | 34.95  | 41.35  | 45.21  |
| Link text should be descriptive         | Moderate | 16.8   | 16.92  | 17.62  | 15.84  |
...
Overall we are seeing positive movement but it's very slow, and without manual testing we are unsure if the changes are being made to pass automated testing or if they are actually improving accessibility.
