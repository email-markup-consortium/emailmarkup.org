...
We're still seeing the same issues as in previous years. The top 10 issues haven't changed order apart from the addition of color contrast.

[TBC]

We were hoping to see better standards across education and government emails becasue generally there are stricter accessibility laws for these.
