...
It's dissapointing to see the same issue come up time and again, however we have seen lower percentages of issues which suggests improvements are being made. Messages with Critical issue have dropped from 66.68% in 2024 to 60.66% in 2025. This could suggest these fixes are being prioritized. 
